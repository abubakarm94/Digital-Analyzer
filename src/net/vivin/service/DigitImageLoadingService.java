...
public class DigitImageLoadingService {
    ...
    public List<DigitImage> loadDigitImages() throws IOException {
        ...
        DataInputStream labelInputStream = new DataInputStream(new FileInputStream(labelFileName));
        DataInputStream imageInputStream = new DataInputStream(new FileInputStream(imageFileName));
