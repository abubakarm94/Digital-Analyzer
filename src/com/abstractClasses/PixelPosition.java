...
public abstract class PixelPosition {
	...
	/*
	 * Re-orders pixel based on how it was read
	 * example: if brought in as ABA --> rearrange to ABA 
	 */
	...
	protected static int Min(List<Integer> neighboringLabels, Map<Integer, Label> allLabels) {
	...
	protected static int Min(List<Pixel> pattern, boolean xOrY) {
		if (pattern.isEmpty())
			return 0; // TODO: is 0 appropriate for empty list
